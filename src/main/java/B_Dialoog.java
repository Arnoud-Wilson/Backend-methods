public class B_Dialoog {
    ...
    private static void bertSays(String sentence) {
        System.out.println("Bert says: " + sentence);
    }

    private static void ernieSays(String sentence) {
        System.out.println(sentence + " says Ernie");
    }
}
